...
public class CareTakerLogin extends HttpServlet {
    ...
    protected void service(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String query = "SELECT \"Caretaker\".\"CT_seq\" FROM \"SeniorCitizen\".\"Caretaker\" WHERE \"CT_mob\" = ? AND \"CT_pwd\" = ?";
            ...
            if (rs.next()) {
                ...
                sess.setAttribute("type", "CT");
                sess.setAttribute("seq", seq);
                response.sendRedirect("/SeniorCitizen/pages/DashboardCT.html");
            } else {
                ...
                pstmt.close();
                conn.close();
                request.getRequestDispatcher("/pages/cartakerFailed.html").include(request, response);
            }
